...
(function() {
  ...
  XMLWriterBase = __webpack_require__(18);
...
var _handlers = __webpack_require__(38);

var _handlers2 = _interopRequireDefault(_handlers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var feed = exports.feed = _handlers2.default.feed;
...
(function() {
  ...
  builder = __webpack_require__(26);
...
(function() {
  ...
  XMLDocument = __webpack_require__(28);

  XMLDocumentCB = __webpack_require__(29);

  XMLStringWriter = __webpack_require__(15);

  XMLStreamWriter = __webpack_require__(30);
...
(function() {
  ...
  XMLStringifier = __webpack_require__(17);
...
(function() {
  ...
  sax = __webpack_require__(32);

  events = __webpack_require__(35);

  bom = __webpack_require__(36);

  processors = __webpack_require__(19);

  setImmediate = __webpack_require__(37).setImmediate;
...
;(function (sax) { // wrapper for non-node envs
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(34).StringDecoder
...
var _feed = __webpack_require__(39);
...
var _xml2js = __webpack_require__(25);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Feed = function () {
  function Feed(callback, id) {
  ...
  (0, _createClass3.default)(Feed, [{
    ...
    value: function request() {
      ...
      _https2.default.request(this.requestOptions, function (res) {
        return _this.parseResponse(res);
      }).end();
    }
  }, {
    key: 'response',
    value: function response(json) {
      this.callback(null, {
        statusCode: 200,
        body: (0, _stringify2.default)(this.filterFeed(json))
      });
    }
  }, {
    key: 'filterFeed',
    value: function filterFeed(json) {
      return json.rss.channel[0].item.map(function (item) {
        return {
    ...
    value: function parseResponse(res) {
      ...
      res.on('data', function (chunk) {
        ...
        (0, _xml2js.parseString)(body, function (err, object) {
          return _this2.response(object);
        });
      });
    }
  }]);
...
Feed.HOST = 'feeds.feedburner.com';

exports.default = function (_ref, context, callback) {
  var pathParameters = _ref.pathParameters;
...
module.exports = !__webpack_require__(40) && !__webpack_require__(44)(function () {
